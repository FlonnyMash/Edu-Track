...
export function DailyQuestBoard({
  ...
  const canCompleteDay =
    mainDone && sideDone && !isDayComplete && !isHistoricalView && !isSubmitting;
  ...
  async function handleCompleteDay() {
    ...
    try {
      ...
      toast.success("Level Up! 🚀", {
        description: `You earned ${data.xpAwarded} XP and ${data.coinsAwarded} Coins! Keep that streak alive!`,
        duration: 5000,
      });
